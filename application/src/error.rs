...
pub enum ExpectedAuthorizationError {
    #[error("")]
    InvalidRequest { entity: &'static str, value: String },
    #[error("")]
    UnAuthorizedClient { entity: &'static str, id: String },
    #[error("")]
    AccessDenied { side: &'static str, value: String },
    #[error("")]
...
impl From<KernelError> for ApplicationError {
    fn from(e: KernelError) -> Self {
        match e {
            ...
            KernelError::JsonWebToken(e) => ApplicationError::Other(e),
            KernelError::Base64Decode(e) => ApplicationError::Other(e),
            KernelError::Serde(e) => ApplicationError::Other(e),
            KernelError::Parse(e) => ApplicationError::Other(e),
        }
    }
}
